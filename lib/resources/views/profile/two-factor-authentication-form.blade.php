    ...
    <x-slot name="content">
        ...
        <div class="mt-4">
            <div class="form-group">
                ...
                <input type="text" id="otp" class="form-control" wire:model.defer="code" name="code"
        ...
        <p class="mt-3">
            {{ __('Store these recovery codes in a secure password manager. They can be used to recover access to your
        ...
        <div class="mt-3">
            ...
            <x-jet-confirms-password wire:then="regenerateRecoveryCodes">
                <x-jet-secondary-button class="me-3">
                    <div wire:loading wire:target="regenerateRecoveryCodes" class="spinner-border spinner-border-sm"
                        role="status">
